...
class Menu():
    ...
    def initilize(self):
        ...
        self.btnSave = Menu_ButtonItem(name="button4", text="Save", width=100, height=50, textSize=50,
                                       mainColor=(220, 120, 110), onMouseOverColor=(0, 205, 205),
                                       centerlocation=(self.screenrect.center[0], self.screenrect.center[1]-60))
        self.objectList.append(self.btnSave)
        ...
        while self.isActive == 0:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    sys.exit()
                elif event == self.btnSave.mouseDownEvent:
                    return "save"
                ...
                self.clock.tick(60)
        Constants.menuTimes += time.clock() - start
